...
function Glucose(glucoseMessage, timeMessage, activationDate, sensorMessage = null, rssi = null) {
  this.inSession = !timeMessage ? true : timeMessage?.sessionStartTime !== 0xffffffff;
  ...
  if (this.inSession) {
    this.sessionStartDate = !timeMessage
      ? activationDate
  ...
  this.filtered = sensorMessage?.filtered;
  this.unfiltered = sensorMessage?.unfiltered;
