        ...
        for (let attempt = 1; attempt <= maxRetries; attempt += 1) {
          ...
          try {
            ...
            */
            ...
            let props = {};
            try {
              props = await device.GetAll('org.bluez.Device1');
            } catch (e) {
              debug('GetAll failed, trying Properties interface...');
              const propsIface = obj.getInterface('org.freedesktop.DBus.Properties');
              props = await propsIface.GetAll('org.bluez.Device1');
            }
