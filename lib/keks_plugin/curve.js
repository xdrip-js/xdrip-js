...
const exponent = curve.getExponent();
console.log('Random exponent (hex):', exponent.toString(16));

// To get a 32-byte big-endian Buffer (matching Java BigInteger.toByteArray() style, but padded)
const exponentBytes = exponent.toArrayLike(Buffer, 'be', 32);
*/
