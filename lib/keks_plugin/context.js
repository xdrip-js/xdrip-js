...
const BN = ecInstance.n.constructor; // Real BN class
...
class Context {
  constructor() {
    ...
    this.packet[1] = new BLEPacket();
    this.packet[2] = new BLEPacket();
    this.packet[3] = new BLEPacket();
    this.sequence = 0;
  ...
  getPasswordBigInteger() {
    ...
    const bn = new BN(Buffer.from(bytes), 16, 'be');
