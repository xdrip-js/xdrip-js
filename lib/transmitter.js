...
Transmitter.prototype.isReady = function() {
  ...
  debug('isReady: transmitting = ' + transmitting);
  if (transmitting) return;
  transmitting = true;
  authenticate.call(this)
  .then(control.bind(this))
  .catch(debug)
  // TODO: consider what happens if the transmitter disconnects
  // before we're finished with it. Will this next line be hit?
  .then(() => {
    transmitting = false;
  });
};
