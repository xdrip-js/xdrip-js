...
const TransmitterResetMessage = require('./messages/transmitter-reset-message');      // 0x42
...
Transmitter.prototype.reset = function() {
    ...
    const sessionStartMessage = new TransmitterResetMessage(0);
    return manager.writeValueAndWait(sessionStartMessage.data, uuid);
}
