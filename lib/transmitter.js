...
module.exports = class Transmitter extends EventEmitter {
  constructor(id, getMessages = (() => []), altBt = false, sensorKey = null, macAddress = null) {
    ...
    this.CalibrationDataRxMessage = (this.g6Transmitter)
      ? require('./messages/g6/calibration-data-rx-message')
      : require('./messages/g5/calibration-data-rx-message');
  ...
  */
  async processVersion() {
    ...
    try {
      ...
      debug('return for version tx type 0 messages invalid');
    }
    ...
    try {
      ...
      debug('return for version tx type 1 messages invalid');
    }
    ...
    try {
      ...
      debug('return for version tx type 2 messages invalid');
    }
  ...
  async isReady(macAddress) {
    ...
    try {
      ...
      if (!Transmitter.g7TxId(this.id)) {
        ...
        activationDate = new Date(Date.now() - glucoseMessage.timestamp - glucoseMessage.age);
