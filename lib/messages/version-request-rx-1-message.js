...
function VersionRequestRx1Message(data) {
  ...
  this.buildVersion = data.readUInt32LE(10);
  this.inactiveDays = data.readUInt16LE(14);
  this.maxRuntimeDays = data.readUInt8(16);
  this.maxInactiveDays = data.readUInt16LE(17);
}
