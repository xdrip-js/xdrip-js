...
describe('SensorRx', () => {
  describe('constructor', () => {
    it('should parse properly constructed G5/G6 SensorRxMessage data', () => {
    ...
    it('should parse properly constructed G6+ SensorRxMessage data', () => {
    ...
    it('should throw if the first byte is not 0x2f', () => {
      (function () {
    ...
    it('should throw if the message is not 16 bytes', () => {
      (function () {
